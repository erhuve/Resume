...
\begin{center}
    ...
    \small 425-394-2960 $|$ \href{mailto:ray.luo@nyu.edu}{\underline{ray.luo@nyu.edu}} $|$ 
    \href{https://linkedin.com/in/~ray}{\underline{linkedin.com/in/\url{~ray}}} $|$
    \href{https://github.com/erhuve}{\underline{github.com/erhuve}}
\end{center}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Integrated with \textbf{B2B} software along with feature flags for tracking usage analytics using \textbf{TypeScript}}
      \resumeItemListEnd
