...
\begin{center}
    ...
    \href{mailto:ray.luo@nyu.edu}{\underline{ray.luo@nyu.edu}} $|$ 
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Full Stack Software Engineer}{Remote, NJ}
      \resumeItemListStart
        \resumeItem{Discovering Better Health!}
      \resumeItemListEnd

    \resumeSubheading
      {Spectrum Labs}{Jan. 2023 -- May 2023}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, Scala, Rust, Java, Hack/PHP, C, SQL} \\
     \textbf{Frameworks}{: Flask, TensorFlow, Selenium, Nuxt} \\
